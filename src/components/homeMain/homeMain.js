...
const HomeMain = () => (
  <main className="main-home">
    ...
    <h2 className="main-home__heading">
        Why
      <span className="span"> small business owners love </span>
        AppCo?
    </h2>
    ...
    <section className="price main-home__price">
      ...
      <div className="price__packages packages">
        ...
        <div className="packages__item">
          ...
          <span className="main-home_package">$149</span>
          <p className="packages__text">
                  Push Notifications
            <br />
                  Data Transfer
